...
Nine more scenes in [`examples/gallery/`](examples/gallery/), proving out IK rigging, the procedural walk generator, secondary-motion springs, and all seven render `look`s — each one still an animation (`docs/gallery-*.mp4`), not just a still.
