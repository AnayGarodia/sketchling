...
Seven longer scenes in [`examples/showcase/`](examples/showcase/), composing the capabilities above together rather than demonstrating one at a time.
